...
@OnlyIn(Dist.CLIENT)
public class SecondaryTranslationContents extends TranslatableContents
{
    ...
    public SecondaryTranslationContents(String key, Language _language) {
        super(key);
        this.key = key;
        this.args = NO_ARGS;
        language = _language;
    ...
    public SecondaryTranslationContents(String key, Language _language, Object... args) {
        super(key, args);
        this.key = key;
        this.args = args;
        language = _language;
    ...
    public boolean equals(Object p_237526_) {
        if (this == p_237526_) {
            ...
            if (p_237526_ instanceof SecondaryTranslationContents translatablecontents) {
                return this.key.equals(translatablecontents.key) && Arrays.equals(this.args, translatablecontents.args);
            }
